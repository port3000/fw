// localSession('a').set(1,12323232, { TTL: 1000*5 });
...
(function(root, factory) {
    ...
    if (typeof define === 'function' && define.amd) {
        ...
        localCache.flush = function() {
            try { localStorage.clear(); } catch (e) {
                return false;
            }
            return true;
        };
        localSession.flush = function() {
    ...
    var res = {
        ...
        get: function(key) {
            ...
            if (typeof _windowStorage === typeof window.sessionStorage) return _storage[key];
